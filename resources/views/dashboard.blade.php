...
<div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 md:space-x-4 p-6 bg-cover bg-center shadow-lg rounded-lg"  style="background-image: url('/storage/images/2.jpg');"> {{-- Replaced with a stable placeholder image --}}
    ...
    {{-- New: Prominent "Anzeige erstellen" button --}}{{-- Assuming you have an 'ads.create' route for your ad creation form --}}
    {{-- <div class="mt-4 md:mt-0 md:ml-4">
     ...
     <nav class="p-4 flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 mt-4 pb-2 border-b border-gray-200 dark:border-gray-700"> {{-- Removed ps-4, space-x-4, overflow-x-auto, added flex-wrap, justify-center, gap-x-4, gap-y-2 --}}
            <a href="{{ route('categories.show', 'fahrzeuge') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white"> {{-- Added padding, rounded, and background for each link --}}
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-car-icon lucide-car"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>
                <span>Fahrzeuge</span>
            </a>
            <a href="{{ route('categories.show', 'fahrzeugeteile') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white">
             ...
             <a href="{{ route('categories.show', 'boote') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white">
            ...
            <a href="{{ route('categories.show', 'elektronik') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white">
            ...
            <a href="{{ route('categories.show', 'haushalt') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white">
            ...
            <a href="{{ route('categories.show', 'immobilien') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house-icon lucide-house"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
                <span>Immobilien</span>
            </a>
            <a href="{{ route('categories.show', 'dienstleistungen') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white">
                ...
                <span>Dienstleistunge</span>
                 ...
                 <a href="{{ route('categories.show', 'sonstiges') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-gray-100 dark:hover:bg-blue-900 dark:text-gray-700 dark:hover:text-white">
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white  overflow-hidden shadow-lg sm:rounded-lg p-6">
                ...
                <h2 class="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-700">Neueste Anzeigen nach Kategorie</h2>
                ...
                @forelse ($adsByCategory as $categorySlug => $ads)
                    @if ($ads->isNotEmpty())
                        <div class="mb-12 border-b border-gray-200 dark:border-gray-700 pb-8 last:border-b-0 last:pb-0">
                            <h4 class="text-2xl font-bold text-gray-800 dark:text-gray-800 mb-6 capitalize flex items-center">
                                ...
                                @endphp
                                {{ $categoryName }}
                                <a href="{{ route('categories.show', $categorySlug) }}" class="ml-auto text-blue-600 hover:text-blue-800 text-base font-semibold transition-colors duration-200">Alle anzeigen &rarr;</a>
                            </h4>
                                ...
                                @foreach ($ads as $ad)
                                    ...
                                    <div class="bg-white dark:bg-white rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="mt-4">
                                                <a href="#" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-blue-700 transition-colors duration-300 shadow-sm hover:shadow-md">Details ansehen</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    @endif
                @empty
                    <p class="text-gray-600 dark:text-gray-400 text-center text-lg py-10">Es sind noch keine Anzeigen verfügbar.</p>
                @endforelse
            </div>
        </div>
    </div>
