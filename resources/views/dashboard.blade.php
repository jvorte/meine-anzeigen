<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 md:space-x-4 p-6 bg-gradient-to-r from-blue-50 to-white dark:from-gray-700 dark:to-gray-800 shadow-lg rounded-lg"> {{-- Added gradient, increased padding, stronger shadow --}}
     ...
     <nav class="p-4 flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 mt-4 pb-2 border-b border-gray-200 dark:border-gray-700"> {{-- Removed ps-4, space-x-4, overflow-x-auto, added flex-wrap, justify-center, gap-x-4, gap-y-2 --}}
            <a href="{{ route('categories.show', 'fahrzeuge') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white"> {{-- Added padding, rounded, and background for each link --}}
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-car-icon lucide-car"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>
                <span>Fahrzeuge</span>
            </a>
            <a href="{{ route('categories.show', 'fahrzeugeteile') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white">
             ...
             <a href="{{ route('categories.show', 'boote') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white">
            ...
            <a href="{{ route('categories.show', 'elektronik') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white">
            ...
            <a href="{{ route('categories.show', 'haushalt') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white">
            ...
            <a href="{{ route('categories.show', 'immobilien') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house-icon lucide-house"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
                <span>Immobilien</span>
            </a>
            <a href="{{ route('categories.show', 'dienstleistungen') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white">
                ...
                <span>Dienstleistunge</span>
                 ...
                 <a href="{{ route('categories.show', 'sonstiges') }}" class="flex items-center space-x-1 text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-1 rounded-full bg-gray-100 hover:bg-blue-100  dark:hover:bg-blue-900 dark:text-gray-900 dark:hover:text-white">
