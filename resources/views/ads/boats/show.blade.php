    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-white rounded-lg shadow-md overflow-hidden">
                <div class="px-6 py-5 bg-white dark:bg-gray-200 border-b border-gray-500 dark:border-gray-200">
                    ...
                    {{-- This div contains the contact seller link and the edit/delete buttons --}}
                    {{-- We need to make this flex container justify its content to the end for the buttons --}}
                    <div class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        {{-- Contact Seller Link (Left aligned by default within flex) --}}
                        @if ($boat->user)
                        ...
                        {{-- Wrapper for Edit and Delete buttons to push them to the right --}}
                        {{-- This div will take up remaining space and push its content to the end --}}
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-3 gap-x-6 mb-6 text-sm">
                        @foreach([
                                'Marke' => $boat->brand ?? 'N/A',
                                'Modell' => $boat->model ?? 'N/A',
