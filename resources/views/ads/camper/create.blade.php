...
<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800 leading-tight">
            Neue Anzeige: Wohnmobil erstellen
        </h2>
    </x-slot>
        ...
        <form method="POST" action="{{ route('ads.camper.store') }}" enctype="multipart/form-data" class="space-y-8">
            ...
            <section class="bg-gray-50 p-6 rounded-lg shadow-inner">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price') }}" placeholder="z.B. 45.000"
                    ...
                    <div>
                        ...
                        <input type="number" name="mileage" id="mileage" value="{{ old('mileage') }}" placeholder="z.B. 75.000"
                               class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        @error('mileage')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
            ...
            <section class="bg-gray-50 p-6 rounded-lg shadow-inner">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {{-- Camper Type --}}
                    <div>
                        <label for="camper_type" class="block text-sm font-medium text-gray-700 mb-2">Wohnmobil-Typ</label>
                        <select name="camper_type" id="camper_type"
                                class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                            <option value="">Bitte wählen</option>
                            @foreach($camperTypes as $type)
                                <option value="{{ $type }}" {{ old('camper_type') == $type ? 'selected' : '' }}>{{ $type }}</option>
                            @endforeach
                        </select>
                        @error('camper_type')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    ...
                    {{-- Berths --}}
                    <div>
                        <label for="berths" class="block text-sm font-medium text-gray-700 mb-2">Anzahl Schlafplätze</label>
                        <input type="number" name="berths" id="berths" value="{{ old('berths') }}" placeholder="z.B. 4" min="1"
                               class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        @error('berths')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" step="0.1" name="total_length" id="total_length" value="{{ old('total_length') }}" placeholder="z.B. 6.5"
                               class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        @error('total_length')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" step="0.1" name="total_width" id="total_width" value="{{ old('total_width') }}" placeholder="z.B. 2.3"
                               class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        @error('total_width')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    {{-- Total Height --}}
                    <div>
                        <label for="total_height" class="block text-sm font-medium text-gray-700 mb-2">Gesamthöhe (in m)</label>
                        <input type="number" step="0.1" name="total_height" id="total_height" value="{{ old('total_height') }}" placeholder="z.B. 2.9"
                               class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        @error('total_height')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
