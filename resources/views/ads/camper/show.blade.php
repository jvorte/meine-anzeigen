                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        @if ($camper->gross_vehicle_weight)
                            <dl>
                                ...
                                <dd class="text-gray-900">{{ number_format($camper->gross_vehicle_weight, 0, ',', '.') }} kg</dd>
                            </dl>
                        @endif
                        ...
                        @if (isset($camper->features) && !empty($camper->features))
                            <dl class="col-span-1 sm:col-span-2"> {{-- Spans full width if a larger description --}}
                                ...
                                <dd class="text-gray-900 leading-relaxed whitespace-pre-wrap">{!! nl2br(e($camper->features)) !!}</dd>
                            </dl>
                        @endif
                    </div>
