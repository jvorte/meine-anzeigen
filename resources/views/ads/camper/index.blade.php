    ...
    <div class="p-6 rounded-xl bg-gray-50 border border-gray-200">
        ...
        <div class="flex flex-wrap items-center gap-4 mb-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('ads.camper.index') }}" class="inline-flex items-center justify-center rounded-lg border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <div x-show="showMoreFilters" x-collapse.duration.300ms class="mt-4 border-t border-gray-200 pt-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                {{-- Camper Type Filter --}}
                <div>
                    <label for="camper_type" class="block text-sm font-medium text-gray-700">Τύπος Camper</label>
                    <select name="camper_type" id="camper_type" class="mt-1 w-full rounded-lg border-gray-300 shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="">Επιλέξτε</option>
                ...
                <div>
                    ...
                    <select name="berths" id="berths" class="mt-1 w-full rounded-lg border-gray-300 shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="">Επιλέξτε</option>
