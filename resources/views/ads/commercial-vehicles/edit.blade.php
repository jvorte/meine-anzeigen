...
<x-app-layout>
    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            ['label' => __('Commercial vehicle ad') , 'url' => route('categories.commercial-vehicles.show', $commercialVehicle->id)],
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="fuel_type" id="fuel_type"
                            ...
                            <option value="Petrol" {{ old('fuel_type', $commercialVehicle->fuel_type) == 'Petrol' ? 'selected' : '' }}>{{ __('Petrol') }}</option>
                    ...
                    <div>
                        <label for="payload_capacity" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Payload') }} (kg)</label>
                    ...
                    <div>
                        <label for="gross_vehicle_weight" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Total weight') }} (kg)</label>
                    ...
                    <div>
                        <label for="number_of_axles" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Number of axes') }}</label>
                    ...
                    <div class="mt-4">
                        <label class="inline-flex items-center">
                            <input
                                ...
                                {{ old('show_phone', $commercialVehicle->show_phone) ? 'checked' : '' }}>
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input
                                ...
                                value="1"
                                class="rounded border-gray-300"
                                {{ old('show_mobile_phone', $commercialVehicle->show_mobile_phone) ? 'checked' : '' }}>
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input
                                ...
                                value="1"
                                class="rounded border-gray-300"
                                {{ old('show_email', $commercialVehicle->show_email) ? 'checked' : '' }}>
