        ...
        <div class="relative flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 md:space-x-4 p-6 bg-cover bg-center shadow-lg rounded-lg"
            ...
            <div class="relative z-10 text-center md:text-left flex-grow">
                <h2 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 leading-tight mb-2">
                    Finde dein nächstes Haushaltsstück
                </h2>
                <p class="text-md text-gray-600 dark:text-gray-100">
                    Entdecke alles für dein Zuhause – von Möbeln bis zu Geräten.
                </p>
            </div>
            ...
            <div class="relative z-10 w-full md:w-1/2 lg:w-2/5">
                <form action="{{ route('ads.search') }}" method="GET">
                    <input type="text" name="query" placeholder="Was suchst du? z.B. Sofa, Kaffeemaschine..."
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-white rounded-lg shadow-md overflow-hidden">
                <div class="px-6 py-5 bg-white dark:bg-gray-100 border-b border-gray-200 dark:border-gray-300">
                    <h3 class="text-4xl font-extrabold text-gray-700 dark:text-gray-800 mb-2 leading-tight">{{ $householdItem->title }}</h3>
                    ...
                    <div class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        @if (isset($householdItem->user_id)) {{-- Assuming you have a user_id on your model --}}
                            {{-- <a href="{{ route('messages.create', $householdItem->user_id) }}" --}}
                ...
                <div class="p-6">
                    ...
                    <h4 class="text-xl font-semibold text-gray-600 mb-4 border-b pb-2 border-gray-200 dark:border-gray-300">Haushaltsartikel Details</h4>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-3 gap-x-6 mb-6 text-sm">
                        ...
                        <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-100 p-3 rounded-md">
                            ...
                            <span class="text-gray-700 dark:text-gray-800">{{ $householdItem->condition ?? 'N/A' }}</span>
                        </div>
                        <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-100 p-3 rounded-md">
                            <span class="font-semibold text-gray-500 dark:text-gray-600">Material:</span>
                            <span class="text-gray-700 dark:text-gray-800">{{ $householdItem->material ?? 'N/A' }}</span>
                        </div>
                        <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-100 p-3 rounded-md">
                        ...
                        {{-- Add more household item-specific details here based on your table --}}
                        {{-- For example: --}}
                        {{-- <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-100 p-3 rounded-md">
                            <span class="font-semibold text-gray-500 dark:text-gray-600">Abmessungen:</span>
                            <span class="text-gray-700 dark:text-gray-800">{{ $householdItem->dimensions ?? 'N/A' }}</span>
                        </div> --}}
                        {{-- <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-100 p-3 rounded-md">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                @foreach ($householdItem->images as $image)
                                    <img src="{{ asset('storage/' . $image->path) }}" alt="Haushaltsartikelbild" class="w-full h-48 object-cover rounded-lg shadow-sm">
                                @endforeach
                            </div>
                        </div>
                    @endif
