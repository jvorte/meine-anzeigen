{{-- resources/views/ads/wohnmobile/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-800 mb-1">Neue Wohnwagen / Wohnmobil Anzeige</h2>
        <p class="text-sm text-gray-500">Fülle das Formular aus, um dein Wohnmobil anzubieten.</p>
    </x-slot>

    <div class="max-w-3xl mx-auto py-8">
        <form method="POST" action="{{ route('ads.wohnmobile.store') }}" enctype="multipart/form-data" class="space-y-6 bg-white p-6 rounded-xl shadow">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Fahrzeugtyp --}}
                <div>
                    <label for="vehicle_type" class="block text-sm font-medium text-gray-700">Typ</label>
                    <select
                        name="vehicle_type"
                        id="vehicle_type"
                        class="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
