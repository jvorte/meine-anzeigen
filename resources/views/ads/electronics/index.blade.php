...
<x-app-layout>
    <x-slot name="header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Όλα τα Ηλεκτρονικά</h1>
                <p class="mt-1 text-gray-600">Περιηγηθείτε σε όλες τις διαθέσιμες καταχωρήσεις ηλεκτρονικών και βρείτε την ιδανική συσκευή για εσάς.</p>
            </div>
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('ads.electronics.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
                    + Νέα Καταχώρηση
                </a>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <x-breadcrumbs :items="[
            ...
            ['label' => 'Ηλεκτρονικά', 'url' => route('categories.electronics.index')],
        ]" class="mb-6" />
