<x-app-layout>
    ...
    <div class="py-2">
        ...
        ['label' => __('New Electronics Ad'), 'url' => null],
    ]" />
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" x-data="{
                         ...
                         categoryFields: {
                             'Mobile Phone': ['color', 'usage_time', 'operating_system', 'storage_capacity', 'processor', 'ram'],
                              'Laptop': ['color', 'usage_time', 'operating_system', 'storage_capacity', 'processor', 'ram'],
                                  'Smartwatch': ['color', 'usage_time', 'operating_system', 'storage_capacity', 'processor', 'ram'],
                                      'Tablet': ['color', 'usage_time', 'operating_system', 'storage_capacity', 'processor', 'ram'],
                                       'Audio Device': ['color', 'usage_time',  'storage_capacity', 'processor', 'ram'],
