...
<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-xl mt-6">
        ...
        <form method="POST" action="{{ route('ads.vehicles-parts.update', $usedVehiclePart) }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select name="part_category" id="part_category"
                            ...
                            <option value="{{ $category }}" {{ old('part_category', $usedVehiclePart->part_category) == $category ? 'selected' : '' }}>{{ __($category) }}</option>
                            @endforeach
                        </select>
                        @error('part_category')
                    ...
                    <div>
                        <label for="part_name" class="block text-sm font-medium text-gray-700 mb-2">{{ __('title') }}</label>
                ...
                <div class="mt-4">
                    <label class="inline-flex items-center">
                        <input
                            ...
                            {{ old('show_phone', $usedVehiclePart->show_phone) ? 'checked' : '' }}>
                ...
                <div class="mt-2">
                    <label class="inline-flex items-center">
                        <input
                            ...
                            value="1"
                            class="rounded border-gray-300"
                            {{ old('show_mobile_phone', $usedVehiclePart->show_mobile_phone) ? 'checked' : '' }}>
                ...
                <div class="mt-2">
                    <label class="inline-flex items-center">
                        <input
                            ...
                            value="1"
                            class="rounded border-gray-300"
                            {{ old('show_email', $usedVehiclePart->show_email) ? 'checked' : '' }}>
