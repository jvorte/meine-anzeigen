            ...
            <div class="flex items-center space-x-3 pt-10">
                @auth
                    @if (auth()->id() === $other->user_id || (auth()->user() && auth()->user()->isAdmin()))
                        <a href="{{ route('ads.real-estate.edit', $other->id) }}" 
                        ...
                        <form action="{{ route('ads.real-estate.destroy', $other->id) }}" method="POST"
...
protected $fillable = [
    ...
    'condition',             // zustand
    'room_count',            // anzahl_zimmer
    'building_type',         // bautyp
    'availability',          // verfugbarkeit
    'fixed_term',            // befristung
    'fixed_term_end',        // befristung_ende
    'description',
    ...
    'plot_area',             // grundflaeche
    'deposit',               // kaution
    'broker_fee',            // maklerprovision
    'buyout_price',          // abloese
    'equipment',             // ausstattung
    'heating',               
    'floor_plan_path',       // grundriss_path
    'energy_certificate_path', // energieausweis_path
    'virtual_tour_link',     // rundgang_link
    'property_info_link',    // objektinformationen_link
    'condition_report_link', // zustandsbericht_link
    'sales_report_link',     // verkaufsbericht_link
    'contact_name',
    'contact_email',
    'homepage',
];
...
protected $casts = [
    'equipment' => 'array',  
    'fixed_term_end' => 'date',
    'additional_contact' => 'boolean', // zusatzkontakt
];
