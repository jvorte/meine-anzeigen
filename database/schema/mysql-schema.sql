...
CREATE TABLE `cars` (
  ...
  `registration` year(4) DEFAULT NULL,
...
CREATE TABLE `real_estates` (
  ...
  `propertyTypeOptions` varchar(255) NOT NULL,
  `title` varchar(255) NOT NULL,
  ...
  `constructionTypeOption` varchar(255) DEFAULT NULL,
  ...
  `price` decimal(10,2) DEFAULT NULL,
  `livingSpace` decimal(10,2) DEFAULT NULL,
